...
public class Day06TheCentralLimitTheoremI
{
	public static void main(String[] args)
	{
		...
		double numBoxes = in.nextDouble();
		double mean = in.nextDouble();
		double standardDeviation = in.nextDouble();
		
		double res = cumulative(mean*numBoxes, standardDeviation* Math.sqrt(numBoxes), maxWeight);
